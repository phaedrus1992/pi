...
var isHook = __webpack_require__(63)
...
var document = __webpack_require__(122)

var applyProperties = __webpack_require__(125)

var isVNode = __webpack_require__(49)
var isVText = __webpack_require__(64)
var isWidget = __webpack_require__(40)
var handleThunk = __webpack_require__(127)
...
var isWidget = __webpack_require__(40)
var isThunk = __webpack_require__(62)
var isVHook = __webpack_require__(63)
...
var raf = __webpack_require__(338)
var TypedError = __webpack_require__(332)
...
var diff = __webpack_require__(342)
var patch = __webpack_require__(343)
var h = __webpack_require__(93)
var create = __webpack_require__(341)
var VNode = __webpack_require__(128)
var VText = __webpack_require__(130)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_median__ = __webpack_require__(336);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_median___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_median__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Contract__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Quality__ = __webpack_require__(357);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Status__ = __webpack_require__(131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Constants__ = __webpack_require__(355);
...
class Market {
	constructor(data) {
		...
		for (var i=0, len=this.Contracts.length; i < len; i++) {
			this.Contracts[i] = new __WEBPACK_IMPORTED_MODULE_1__Contract__["a" /* Contract */](this.Contracts[i]);
		}
	}
	...
	isResolving() {
		if (this.isLinked()) {
			...
			let m = __WEBPACK_IMPORTED_MODULE_0_median___default()(yeses);
	...
	yesQuality() {
		if (this.Contracts.length < 2) {
			return new __WEBPACK_IMPORTED_MODULE_2__Quality__["a" /* Quality */](this);
		}

		let costs = this.Contracts.map((c) => {
			return c.BestBuyYesCost;
		});
		if (__WEBPACK_IMPORTED_MODULE_4__Constants__["a" /* DEBUG */]) { console.log('Yes costs: ',costs); }
		...
		if (__WEBPACK_IMPORTED_MODULE_4__Constants__["a" /* DEBUG */]) { console.log('Yes total spent: $' + totalSpent.toFixed(2)); }

		if (isNaN(totalSpent)) {
			if (__WEBPACK_IMPORTED_MODULE_4__Constants__["a" /* DEBUG */]) { console.log('Some yes contracts have no available shares.  Bailing.'); }
			return new __WEBPACK_IMPORTED_MODULE_2__Quality__["a" /* Quality */](this);
		}
		...
		for (let contract of this.Contracts) {
			...
			if (__WEBPACK_IMPORTED_MODULE_4__Constants__["a" /* DEBUG */]) { console.log('Yes ' + contract.Name + ': percentGainOrLoss=' + percentGainOrLoss.toFixed(2)); }
		}

		return new __WEBPACK_IMPORTED_MODULE_2__Quality__["a" /* Quality */](this, profits);
	}
	...
	noQuality() {
		...
		if (__WEBPACK_IMPORTED_MODULE_4__Constants__["a" /* DEBUG */]) { console.log('No costs: ',costs); }
		...
		if (__WEBPACK_IMPORTED_MODULE_4__Constants__["a" /* DEBUG */]) { console.log('No total spent: $' + totalSpent.toFixed(2)); }

		if (isNaN(totalSpent)) {
			if (__WEBPACK_IMPORTED_MODULE_4__Constants__["a" /* DEBUG */]) { console.log('Some no contracts have no available shares.  Bailing.'); }
			return new __WEBPACK_IMPORTED_MODULE_2__Quality__["a" /* Quality */](this);
		}
		...
		for (let contract of this.Contracts) {
			...
			if (__WEBPACK_IMPORTED_MODULE_4__Constants__["a" /* DEBUG */]) { console.log("No " + (contract.Name) + " (" + cost + "):" + percentGainOrLoss.toFixed(2) + "%"); }
			...
			if (__WEBPACK_IMPORTED_MODULE_4__Constants__["a" /* DEBUG */]) { console.log('No ' + contract.Name + ': percentGainOrLoss=' + percentGainOrLoss.toFixed(2)); }
		}
...
var extend = __webpack_require__(354)
...
var OneVersionConstraint = __webpack_require__(335);
...
var Individual = __webpack_require__(334);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(65), __webpack_require__(124)))
...
var createElement = __webpack_require__(126)
...
var diff = __webpack_require__(353)
...
var patch = __webpack_require__(346)
...
var isWidget = __webpack_require__(40)
var VPatch = __webpack_require__(129)

var updateWidget = __webpack_require__(347)
...
var render = __webpack_require__(126)
var domIndex = __webpack_require__(344)
var patchOp = __webpack_require__(345)
module.exports = patch
...
var parseTag = __webpack_require__(351);
var softSetHook = __webpack_require__(349);
var evHook = __webpack_require__(348);
...
var split = __webpack_require__(149);
...
var diffProps = __webpack_require__(352)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__data_no_awful_json__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__data_no_awful_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__data_no_awful_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_no_bad_json__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_no_bad_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__data_no_bad_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_no_mixed_json__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_no_mixed_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__data_no_mixed_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data_no_good_json__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data_no_good_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__data_no_good_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__data_no_great_json__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__data_no_great_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__data_no_great_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__data_yes_awful_json__ = __webpack_require__(144);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__data_yes_awful_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__data_yes_awful_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__data_yes_bad_json__ = __webpack_require__(145);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__data_yes_bad_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__data_yes_bad_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__data_yes_mixed_json__ = __webpack_require__(148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__data_yes_mixed_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__data_yes_mixed_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__data_yes_good_json__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__data_yes_good_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__data_yes_good_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__data_yes_great_json__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__data_yes_great_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__data_yes_great_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__data_aggregate_UU_json__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__data_aggregate_UU_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__data_aggregate_UU_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__data_aggregate_UA_json__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__data_aggregate_UA_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__data_aggregate_UA_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__data_aggregate_AA_json__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__data_aggregate_AA_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12__data_aggregate_AA_json__);
...
const NO_MARKET_AWFUL  = __WEBPACK_IMPORTED_MODULE_0__data_no_awful_json__;
/* unused harmony export NO_MARKET_AWFUL */

const NO_MARKET_BAD    = __WEBPACK_IMPORTED_MODULE_1__data_no_bad_json__;
/* unused harmony export NO_MARKET_BAD */

const NO_MARKET_MIXED  = __WEBPACK_IMPORTED_MODULE_2__data_no_mixed_json__;
/* unused harmony export NO_MARKET_MIXED */

const NO_MARKET_GOOD   = __WEBPACK_IMPORTED_MODULE_3__data_no_good_json__;
/* unused harmony export NO_MARKET_GOOD */

const NO_MARKET_GREAT  = __WEBPACK_IMPORTED_MODULE_4__data_no_great_json__;
/* unused harmony export NO_MARKET_GREAT */


const YES_MARKET_AWFUL = __WEBPACK_IMPORTED_MODULE_5__data_yes_awful_json__;
/* unused harmony export YES_MARKET_AWFUL */

const YES_MARKET_BAD   = __WEBPACK_IMPORTED_MODULE_6__data_yes_bad_json__;
/* unused harmony export YES_MARKET_BAD */

const YES_MARKET_MIXED = __WEBPACK_IMPORTED_MODULE_7__data_yes_mixed_json__;
/* unused harmony export YES_MARKET_MIXED */

const YES_MARKET_GOOD  = __WEBPACK_IMPORTED_MODULE_8__data_yes_good_json__;
/* unused harmony export YES_MARKET_GOOD */

const YES_MARKET_GREAT = __WEBPACK_IMPORTED_MODULE_9__data_yes_great_json__;
/* unused harmony export YES_MARKET_GREAT */


const AGGREGATE_UU = __WEBPACK_IMPORTED_MODULE_10__data_aggregate_UU_json__;
/* unused harmony export AGGREGATE_UU */

const AGGREGATE_UA = __WEBPACK_IMPORTED_MODULE_11__data_aggregate_UA_json__;
/* unused harmony export AGGREGATE_UA */

const AGGREGATE_AA = __WEBPACK_IMPORTED_MODULE_12__data_aggregate_AA_json__;
/* unused harmony export AGGREGATE_AA */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Status__ = __webpack_require__(131);
...
class Quality {
	...
	recalculate(threshold=5.0) {
		...
		this.status = __WEBPACK_IMPORTED_MODULE_0__Status__["a" /* Status */].UNKNOWN;
		...
		if (this.profits && this.profits.length > 0) {
			...
			if (this.lowest < 0 && this.highest > 0) {
				if (this.average >= 0) {
					this.status = __WEBPACK_IMPORTED_MODULE_0__Status__["a" /* Status */].MIXED;
				} else {
					this.status = __WEBPACK_IMPORTED_MODULE_0__Status__["a" /* Status */].BAD;
				}
			} else if (this.lowest > 0) {
				if (this.average >= threshold) {
					this.status = __WEBPACK_IMPORTED_MODULE_0__Status__["a" /* Status */].GREAT;
				} else {
					this.status = __WEBPACK_IMPORTED_MODULE_0__Status__["a" /* Status */].GOOD;
				}
			} else {
				if (this.average < (threshold * -1.0)) {
					this.status = __WEBPACK_IMPORTED_MODULE_0__Status__["a" /* Status */].AWFUL;
				} else {
					this.status = __WEBPACK_IMPORTED_MODULE_0__Status__["a" /* Status */].BAD;
				}
			}
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Quality;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_virtual_dom_h__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_virtual_dom_h__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_virtual_dom__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_virtual_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_virtual_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_main_loop__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_main_loop___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_main_loop__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Market__ = __webpack_require__(135);
...
function render(state) {
	...
	let rows = [
		__WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default()('tr', [
			__WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default()('th', ['']),
			__WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default()('th', ['Name']),
			__WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default()('th', ['Buy Yes']),
			__WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default()('th', ['Buy No'])
		])
	];
	...
	state.markets.forEach((market) => {
		...
		rows.push(
			__WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default()('tr', [
				__WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default()('td', {
					attributes: {
						class: 'status-' + bestStatus.label
					}
				}, '\u00A0'),
				__WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default()('td', [
					__WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default()('a', {
						href: market.URL,
						attributes: {
							class: 'status-link'
						},
				...
				__WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default()('td', [
					__WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default()('a', {
						...
						__WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default()('img', {
							src: yesImage,
							attributes: {
								class: 'status-icon',
								width: '32', height: '32'
	...
	return __WEBPACK_IMPORTED_MODULE_1_virtual_dom_h___default()('table', {
		attributes: {
			cellspacing: 0
		}
	}, rows);
...
var loop = __WEBPACK_IMPORTED_MODULE_3_main_loop___default()({ markets: [], matched: [] }, render, __WEBPACK_IMPORTED_MODULE_2_virtual_dom___default.a);
...
function handleChanges(changes) {
	...
	for (let i=0, len=updates.markets.length; i < len; i++) {
		updates.markets[i] = new __WEBPACK_IMPORTED_MODULE_4__Market__["a" /* Market */](updates.markets[i]);
	}
	for (let i=0, len=updates.matched.length; i < len; i++) {
		updates.matched[i] = new __WEBPACK_IMPORTED_MODULE_4__Market__["a" /* Market */](updates.matched[i]);
	}
