...
var _Market = __webpack_require__(300);

var _MarketTracker = __webpack_require__(319);

console.log('background.js loaded');

var tracker = new _MarketTracker.MarketTracker();

var cb = function cb(markets) {
	...
	try {
		for (var _iterator = markets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
			var market = _step.value;

			if (market.isLinked()) {
				var yes = market.yesQuality();
				var no = market.noQuality();
...
exports.Market = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _Contract = __webpack_require__(310);

var _Quality = __webpack_require__(311);

var _Status = __webpack_require__(299);
...
var Market = exports.Market = function () {
	function Market(data) {
		_classCallCheck(this, Market);

		Object.assign(this, data);
		for (var i = 0, len = this.Contracts.length; i < len; i++) {
			this.Contracts[i] = new _Contract.Contract(this.Contracts[i]);
		}
	}
	...
	_createClass(Market, [{
		...
		key: 'aggregateStatusValue',
		value: function aggregateStatusValue() {
			var yes = this.yesQuality();
			var no = this.noQuality();

			return yes.status.value + no.status.value;
		}
	}, {
		key: 'yesQuality',
		value: function yesQuality() {
			if (this.Contracts.length < 2) {
				return new _Quality.Quality(this);
			}

			var costs = this.Contracts.map(function (c) {
				return c.BestBuyYesCost;
			});
			if (Constants.DEBUG) {
				console.log('Yes costs: ', costs);
			}

			var totalSpent = costs.includes(null) ? NaN : costs.reduce(function (prev, current) {
				return prev + current;
			});

			if (Constants.DEBUG) {
				console.log('Yes total spent: $' + totalSpent.toFixed(2));
			}

			if (isNaN(totalSpent)) {
				if (Constants.DEBUG) {
					console.log('Some yes contracts have no available shares.  Bailing.');
				}
				return new _Quality.Quality(this);
			}
			...
			try {
				for (var _iterator = this.Contracts[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					var contract = _step.value;

					var cost = contract.BestBuyYesCost;

					var spent = totalSpent - cost;
					var profit = (1 - cost) * .9 - spent;
					...
					if (Constants.DEBUG) {
						console.log('Yes ' + contract.Name + ': percentGainOrLoss=' + percentGainOrLoss.toFixed(2));
					}
				}
			} catch (err) {
				_didIteratorError = true;
			...
			return new _Quality.Quality(this, profits);
		}
	}, {
		key: 'noQuality',
		value: function noQuality() {
			if (this.Contracts.length < 2) {
				return new _Quality.Quality(this);
			}
			...
			if (Constants.DEBUG) {
				console.log('No total spent: $' + totalSpent.toFixed(2));
			}

			if (isNaN(totalSpent)) {
				if (Constants.DEBUG) {
					console.log('Some no contracts have no available shares.  Bailing.');
				}
				return new _Quality.Quality(this);
			}
			...
			try {
				for (var _iterator2 = this.Contracts[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
					var contract = _step2.value;

					var total = 0;
					var cost = contract.BestBuyNoCost;
					...
					try {
						for (var _iterator3 = this.Contracts[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
							var c = _step3.value;

							if (c.ID !== contract.ID) {
								var profit = (1.0 - c.BestBuyNoCost) * 0.9;
								total += profit;
							}
						}
					...
					if (Constants.DEBUG) {
						console.log("No " + contract.Name + " (" + cost + "):" + percentGainOrLoss.toFixed(2) + "%");
					}
					...
					if (Constants.DEBUG) {
						console.log('No ' + contract.Name + ': percentGainOrLoss=' + percentGainOrLoss.toFixed(2));
					}
				}
			} catch (err) {
...
exports.AGGREGATE_AA = exports.AGGREGATE_UA = exports.AGGREGATE_UU = exports.YES_MARKET_GREAT = exports.YES_MARKET_GOOD = exports.YES_MARKET_MIXED = exports.YES_MARKET_BAD = exports.YES_MARKET_AWFUL = exports.NO_MARKET_GREAT = exports.NO_MARKET_GOOD = exports.NO_MARKET_MIXED = exports.NO_MARKET_BAD = exports.NO_MARKET_AWFUL = exports.DEBUG = undefined;

var _noAwful = __webpack_require__(301);

var noAwful = _interopRequireWildcard(_noAwful);

var _noBad = __webpack_require__(302);

var noBad = _interopRequireWildcard(_noBad);

var _noMixed = __webpack_require__(303);

var noMixed = _interopRequireWildcard(_noMixed);

var _noGood = __webpack_require__(312);

var noGood = _interopRequireWildcard(_noGood);

var _noGreat = __webpack_require__(313);

var noGreat = _interopRequireWildcard(_noGreat);

var _yesAwful = __webpack_require__(304);

var yesAwful = _interopRequireWildcard(_yesAwful);

var _yesBad = __webpack_require__(305);

var yesBad = _interopRequireWildcard(_yesBad);

var _yesMixed = __webpack_require__(308);

var yesMixed = _interopRequireWildcard(_yesMixed);

var _yesGood = __webpack_require__(306);

var yesGood = _interopRequireWildcard(_yesGood);

var _yesGreat = __webpack_require__(307);

var yesGreat = _interopRequireWildcard(_yesGreat);

var _aggregateUU = __webpack_require__(318);

var aggregateUU = _interopRequireWildcard(_aggregateUU);

var _aggregateUA = __webpack_require__(317);

var aggregateUA = _interopRequireWildcard(_aggregateUA);

var _aggregateAA = __webpack_require__(316);

var aggregateAA = _interopRequireWildcard(_aggregateAA);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var DEBUG = exports.DEBUG = false;

var NO_MARKET_AWFUL = exports.NO_MARKET_AWFUL = noAwful;
var NO_MARKET_BAD = exports.NO_MARKET_BAD = noBad;
var NO_MARKET_MIXED = exports.NO_MARKET_MIXED = noMixed;
var NO_MARKET_GOOD = exports.NO_MARKET_GOOD = noGood;
var NO_MARKET_GREAT = exports.NO_MARKET_GREAT = noGreat;

var YES_MARKET_AWFUL = exports.YES_MARKET_AWFUL = yesAwful;
var YES_MARKET_BAD = exports.YES_MARKET_BAD = yesBad;
var YES_MARKET_MIXED = exports.YES_MARKET_MIXED = yesMixed;
var YES_MARKET_GOOD = exports.YES_MARKET_GOOD = yesGood;
var YES_MARKET_GREAT = exports.YES_MARKET_GREAT = yesGreat;

var AGGREGATE_UU = exports.AGGREGATE_UU = aggregateUU;
var AGGREGATE_UA = exports.AGGREGATE_UA = aggregateUA;
var AGGREGATE_AA = exports.AGGREGATE_AA = aggregateAA;
...
var Contract = exports.Contract = function Contract(data) {
...
var Quality = exports.Quality = function () {
	function Quality(market, profits) {
		var threshold = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 5.0;
	...
	_createClass(Quality, [{
		...
		value: function recalculate() {
			var threshold = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 5.0;

			this.threshold = threshold;

			this.status = _Status.Status.UNKNOWN;

			if (this.profits && this.profits.length > 0) {
				this.lowest = this.profits.reduce(function (a, b) {
					return Math.min(a, b);
				});
				this.highest = this.profits.reduce(function (a, b) {
					return Math.max(a, b);
				});

				var total = this.profits.reduce(function (a, b) {
					return a + b;
				});
				...
				if (this.lowest < 0 && this.highest > 0) {
					if (this.average >= 0) {
						this.status = _Status.Status.MIXED;
					} else {
						this.status = _Status.Status.BAD;
					}
				} else if (this.lowest > 0) {
					if (this.average >= threshold) {
						this.status = _Status.Status.GREAT;
					} else {
						this.status = _Status.Status.GOOD;
					}
				} else {
					if (this.average < threshold * -1.0) {
						this.status = _Status.Status.AWFUL;
					} else {
						this.status = _Status.Status.BAD;
					}
				}
...
exports.MarketTracker = undefined;
...
var MarketTracker = exports.MarketTracker = function () {
	function MarketTracker() {
		var refreshInterval = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 60000;

		_classCallCheck(this, MarketTracker);

		this.setRefreshInterval(refreshInterval);
		this.subscriptions = [];
	}

	_createClass(MarketTracker, [{
		key: 'setRefreshInterval',
		value: function setRefreshInterval(refreshInterval) {
		...
		value: function start() {
			...
			var doRefresh = function doRefresh() {
				_this.refreshMarkets().then(function (m) {
		...
		value: function onUpdate() {
			var markets = (0, _lodash2.default)(this.markets);
			var _iteratorNormalCompletion = true;
			var _didIteratorError = false;
			var _iteratorError = undefined;
					...
					if (request.status === 200) {
						try {
							...
							if (resp.Markets && resp.Markets.length > 0) {
								...
								try {
									for (var _iterator2 = resp.Markets[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
										var market = _step2.value;

										markets.push(new _Market.Market(market));
									}
								} catch (err) {
									_didIteratorError2 = true;
									_iteratorError2 = err;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(113), __webpack_require__(321)(module)))
